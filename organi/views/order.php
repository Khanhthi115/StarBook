...
<section class="order-container">
    ...
    <form action="views\momoQR.php" class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
        ...
        <input type="hidden" value="<?php echo 30000 + $total ?>" name="total_momo">
        <input style="max-width: 50%; margin-left: 25%;" type="submit" name="momo" value="Thanh toán MOMO QRcode" class="btn btn-danger">
    </form>
    <p></p>
    <form action="views\momoATM.php" class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
        action="init_payment.php">
        <input type="hidden" value="<?php echo 30000 + $total ?>" name="total_momo">
        <input style="max-width: 50%; margin-left: 25%;" type="submit" name="momo" value="Thanh toán MOMO ATM" class="btn btn-danger">
    </form>
</section>  