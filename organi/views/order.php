...
<div class="container-order">
    ...
    <div class="order-container">
        <div class="order-list-products">
            ...
            <p></p>
            <b>Tổng tiền: <?= $total < min_money ? number_format($total + shipping_fee) : number_format($total) ?>đ (đã
                tính phí ship)</b>
        </div>
        <div class="order-info">
            ...
            <form class="btn-momo-container" action="views\momoQR.php" class="" method="POST" target="_blank"
                enctype="application/x-www-form-urlencoded" action="init_payment.php">
                <input type="hidden" value="<?= $total < min_money ? $total + shipping_fee : $total ?>"
                    name="total_momo">
                <input type="submit" name="momo" value="Thanh toán MOMO QRcode" class="btn btn-danger btn-momo">
            </form>
            <p></p>
            <form class="btn-momo-container" action="views\momoATM.php" class="" method="POST" target="_blank"
                enctype="application/x-www-form-urlencoded" action="init_payment.php">
                <input type="hidden" value="<?= $total < min_money ? $total + shipping_fee : $total ?>"
                    name="total_momo">
            ...
            <p></p>
            <p style="text-align: center">Hoặc thanh toán ngay với ONEPAY</p>
            <form class="btn-momo-container" action="views\onepay.php" class="" method="POST" target="_blank"
                enctype="application/x-www-form-urlencoded">
                <input type="hidden" value="<?= $total < min_money ? $total + shipping_fee : $total ?>"
                    name="total_momo">
                <input type="submit" name="momo" value="Thanh toán ONEPAY" class="btn btn-danger btn-momo">
            </form>
        </div>
    </div>
</div>
