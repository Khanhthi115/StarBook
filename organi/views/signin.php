                ...
                <div class="signup-form">
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" value="<?= isset($username) ? $username : "" ?>" id="name" placeholder="Tên đăng nhập" />
                            <p style="color:red;"><?= isset($errorTK) ? $errorTK : ""?></p>
                        </div>
                        <div class="form-group">
                            <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                            <input type="password" name="password" id="pass" placeholder="Mật khẩu" />
                            <p style="color:red;"><?= isset($errorMK) ? $errorMK : ""?></p>
                            <p style="color:red;"><?= isset($errors) ? $errors : ""?></p>
                            <p style="color:red;"><?= isset($warnings) ? $warnings : ""?></p>
                        </div>
