...
<section style="text-align:center">
    <a href="?option=author_add" class="btn btn-success mb-3">Thêm tác giả</a>
</section>
    ...
    <tbody>
        ...
        <?php foreach ($result as $item) : ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-info text-white" href="?option=author_update&id=<?=$item['id']?>">Update</a>
