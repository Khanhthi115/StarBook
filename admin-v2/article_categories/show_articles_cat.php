...
<section style="text-align:center">
    <a href="?option=article_categories_add" class="btn btn-success mb-3">Thêm danh mục bài viết</a>
</section>
    ...
    <tbody>
        ...
        <?php foreach ($result as $item) : ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-info text-white" href="?option=article_categories_update&id=<?= $item['id'] ?>">Update</a>
