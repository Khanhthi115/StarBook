...
<section style="text-align:center">
    <a href="?option=product_add" class="btn btn-success mb-3">Thêm sản phẩm</a>
</section>
    ...
    <tbody>
        ...
        <?php foreach ($result as $item) : ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-info text-white" href="?option=product_update&id=<?= $item['id'] ?>">Update</a>
