...
<section style="text-align:center">
    <a href="?option=product_cat_add" class="btn btn-success mb-3">Thêm danh mục sản phẩm</a>
</section>
<table class="table table-bordered" style="text-align: center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-info text-white" href="?option=product_cat_update&id=<?= $item['id'] ?>">Update</a>
